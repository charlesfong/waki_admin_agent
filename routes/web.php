...
Auth::routes();
Route::get('/waki', 'DataNewController@adminListIndex')->name('waki');
Route::get('/add', 'DataNewController@showadd')->name('add');
Route::post('/edit/', 'DataNewController@edit')->name('edit_member');
Route::post('/deletemember', 'DataNewController@delete')->name('delete_member');
Route::get('/adminmemberdetails/{id}', 'DataNewController@adminDetailsIndex')->name('admin_member_details');
Route::post('/update/', 'DataNewController@update')->name('update_member');
Route::get('register', 'DataNewController@singleIndex')->name('single_register');
Route::post('/register', 'DataNewController@register')->name('member_register');
Route::get('getagentbycode', 'DataNewController@getAgentByCode')->name('get_agent_by_code');
Route::get('/adminagentdetails/{id}', 'DataNewController@adminAgentDetailsIndex')->name('admin_agent_details');
